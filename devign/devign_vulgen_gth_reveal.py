...
if __name__ == '__main__':
    ...
    #model = torch.load("./models/devign_vulgen_reveal/GGNNSumModel-model.bin1919_saved")
    is_test = True
    if is_test:
        model.eval()
        model = torch.load("./models/devign_vulgen_gth_reveal/GGNNSumModel-model.bin1919x")
    else:
        model.train()
